...
class PositionControllerNode:
    ...
    def odometry_callback(self, msg):
        ...
        ang_v= numpy.array([msg.twist.twist.angular.x,msg.twist.twist.angular.y,msg.twist.twist.angular.z])
        ...
        v_linear = self.pid_pos.regulate(e_pos_body, t)  * self.velocity_gain  #We can reduce the output of the cmd_vel if desired
        v_angular = self.pid_rot.regulate(self.quat_des,q, ang_v,t)
